...
import { useAuth } from '../Components/AuthContext'; // Importa el contexto de autenticación para manejar el usuario
    ...
    <Navbar expand="lg" className="color-navbar fixed-top">
      <Container>
        ...
        <Nav className="d-flex align-items-center">
          {/* Logo de la new Intl.NumberFormat("es-PE" */}
          <img
            className="imagen_logo"
            src={require("../images/Logo-vicava.png")} // Carga la imagen del logo desde la carpeta local
            alt="Logo de Tienda Serven"
          />
          {/* Nombre de la tienda con enlace a la página principal */}
          <Navbar.Brand href="/home" className="ms-3">
            Tienda Serven Vicava
          </Navbar.Brand>
